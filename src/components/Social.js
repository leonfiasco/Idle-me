      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col">
            ...
            <img className="fb-icon" alt="fb-icon" href="" src="https://www.dropbox.com/pri/get/facebook_white.svg?_subject_uid=1250722080&raw=1&size=1280x960&size_mode=3&w=AAC_J7xBpBsnu7og2YQYcKqtYkbUyWypt1NLalmSb4Q0UQ"></img>
          ...
          <div className="col">
            ...
            <h6 className="social-h6">Taking @onidledesign to the #tabaccodock
#WorldCheeseAwards @loveswisscheese
won 2 x Gold & 2 X Bronze... Congrats...</h6>
            <p className="social-p">19. November 2017</p>
              <p className="more2" href="">Foll<u>ow</u><u> </u><u>us</u></p>
          </div>
        </div>
      </div>
    );
